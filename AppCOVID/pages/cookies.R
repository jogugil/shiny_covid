cookies <- function(title, content) {
  tagList(
    tags$title("Cookies - - Data Visualization Group Mini-Project - GCD. UV"),
    tags$div(
        ...
        tags$table(
            ...
            tags$tbody(
                ...
                tags$tr(
                    ...
                    tags$td(
                        class="govuk-table__cell",
                        "These help us count how many people visit data.gov.es by tracking if you’ve visited before"
                    ),
                    tags$td(
                        class="govuk-table__cell",
